...
draw_set_alpha(0.5);
draw_set_color(#52fcff);
draw_rectangle(x1, y1 + 2, x1 + (width * airMeter), y2, false);
...
if (air > 0) {
    ...
    draw_sprite_ext(sHeartUI, 1, width - margin , height, 0.25, 0.25, 0, c_white, 1);
    draw_set_alpha(0.85);
    draw_set_color(#721d48);
